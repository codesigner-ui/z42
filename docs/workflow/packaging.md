...
# NDK：./scripts/setup-tools.sh android（装到 artifacts/tools/android-ndk）
...
| `$ANDROID_NDK_HOME unset and NDK not found locally` | `./scripts/setup-tools.sh android` 或 `export ANDROID_NDK_HOME=<path>` |
