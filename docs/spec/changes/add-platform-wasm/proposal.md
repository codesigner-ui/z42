...
- **文档**：[platform/wasm/README.md](platform/wasm/README.md) + [docs/design/runtime/cross-platform.md](docs/design/runtime/cross-platform.md) wasm 段
...
| `docs/design/runtime/cross-platform.md` | MODIFY | wasm 段（架构 / API / 限制） |
...
- [docs/design/runtime/cross-platform.md](docs/design/runtime/cross-platform.md) — P4.1 已建好
