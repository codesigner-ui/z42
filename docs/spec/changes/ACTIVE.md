...
| `stdlib` | add-reflection-mvp | 2026-06-08 | 反射 MVP：z42.core 扩展 Type + Std.Reflection 类（feat 30776fae 已提交）。（add-binary-float / compression-decoder-pull-mode / add-file-last-write-time / add-directory-copy 均曾例外共存于非 z42.core 的 stdlib 库，已归档释放）|
