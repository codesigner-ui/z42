...
|--------|----------------|------|------|
| `compiler` | —（空闲）| — | C3b add-attribute-reflection-methods 已归档 2026-06-09 → 释放 |
| `runtime` | —（空闲）| — | C3b 已归档 2026-06-09 → 释放 |
| `stdlib` | —（空闲）| — | C3b 已归档 2026-06-09 → 释放 |
...
| `toolchain` | port-z42c-core | 2026-06-07 | xtask test compiler-z42 接入 z42-test-runner 跑 z42c [Test]。（add-apphost 并行占用已于 2026-06-09 归档释放。）|
