...
| `runtime` | —（空闲）| — | add-reflection-properties 已归档 2026-06-09 → 释放（`__type_properties` builtin，无格式变更）|
| `stdlib` | —（空闲）| — | add-reflection-properties 已归档 2026-06-09 → 释放（`PropertyInfo` + `Type.GetProperties()`）|
