...
| `docs/spec/changes/impl-local-fn-l2/proposal.md` | NEW | 本提案 |
| `docs/spec/changes/impl-local-fn-l2/specs/local-fn/spec.md` | NEW | 行为规范 |
| `docs/spec/changes/impl-local-fn-l2/design.md` | NEW | 实现设计 |
