...
**文档影响：** `docs/design/language/language-overview.md`（短路语义）、`docs/design/language/generics.md`（G4g 限制列表移除短路项）、`docs/roadmap.md`（G4h 进度）。
...
- [x] 1.4 `docs/design/language/language-overview.md` 增补短路语义描述（§3.5）
- [x] 1.5 `docs/design/language/generics.md` G4g 限制列表删除 "&&/|| 不短路" 项
