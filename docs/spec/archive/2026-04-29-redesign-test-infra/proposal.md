...
**本变更交付的是「全局规划 + 4 份正式 spec 文档」**，把工作拆成 5 个独立 Phase，每个 Phase 后续单独立 `docs/spec/changes/<name>/` 落地。本变更**不交付任何代码**，只交付：proposal、design、spec、tasks 四份文档以及目录占位。

## What Changes

- 新建 [docs/spec/changes/redesign-test-infra/](docs/spec/changes/redesign-test-infra/) 容器
...
| 文件路径 | 变更类型 | 说明 |
|---------|---------|------|
| [docs/spec/changes/redesign-test-infra/proposal.md](docs/spec/changes/redesign-test-infra/proposal.md) | NEW | 本文件 |
| [docs/spec/changes/redesign-test-infra/design.md](docs/spec/changes/redesign-test-infra/design.md) | NEW | 完整设计：归属规则、工具链、benchmark、CI、跨平台、Phase 计划 |
| [docs/spec/changes/redesign-test-infra/specs/test-infrastructure/spec.md](docs/spec/changes/redesign-test-infra/specs/test-infrastructure/spec.md) | NEW | 可验证场景：每个 Phase 完成后的对外可观察行为 |
| [docs/spec/changes/redesign-test-infra/tasks.md](docs/spec/changes/redesign-test-infra/tasks.md) | NEW | 实施清单：5 个 Phase 的子 spec 占位与顺序 |
