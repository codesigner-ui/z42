...
- [x] 阶段 E: P3 子 spec（用例迁移）—— `docs/spec/archive/2026-05-05-migrate-runtime-tests-by-ownership/` 已落地（按 dotnet/runtime 风格分类）
- [部分] 阶段 F: P4 子 spec（跨平台）—— **F.1 已落地** `docs/spec/archive/2026-05-07-add-runtime-feature-flags/` (commit 215f289)；F.2/F.3/F.4 已写完 proposal + design + tasks，待实施
...
| P2 add-z42-test-runner | DRAFT 已写 | `docs/spec/changes/rewrite-z42-test-runner-compile-time/` |
| P3 migrate-tests-by-ownership | ✅ 已归档 | `docs/spec/archive/2026-05-05-migrate-runtime-tests-by-ownership/` |
| F.1 add-runtime-feature-flags | ✅ 已归档 | `docs/spec/archive/2026-05-07-add-runtime-feature-flags/` |
| F.2 add-platform-wasm | DRAFT 已写 | `docs/spec/changes/add-platform-wasm/` |
| F.3 add-platform-android | DRAFT 已写 | `docs/spec/changes/add-platform-android/` |
| F.4 add-platform-ios | DRAFT 已写 | `docs/spec/changes/add-platform-ios/` |

---

## 阶段 A: 本变更规范文档

- [x] A.1 创建 [docs/spec/changes/redesign-test-infra/](docs/spec/changes/redesign-test-infra/) 目录
- [x] A.2 写 [proposal.md](docs/spec/changes/redesign-test-infra/proposal.md)
- [x] A.3 写 [design.md](docs/spec/changes/redesign-test-infra/design.md)
- [x] A.4 写 [specs/test-infrastructure/spec.md](docs/spec/changes/redesign-test-infra/specs/test-infrastructure/spec.md)
- [x] A.5 写本 tasks.md
...
>
> **2026-05-05 状态更新**：由 [`docs/spec/changes/migrate-runtime-tests-by-ownership/`](../migrate-runtime-tests-by-ownership/) 落地（按 dotnet/runtime 风格分类，非原计划"VM-only 留 runtime/tests/golden/run/"模式）。变化见该 spec 的 tasks.md。
