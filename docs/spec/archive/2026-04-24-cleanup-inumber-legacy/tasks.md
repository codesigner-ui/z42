...
**文档影响**：
- `docs/design/language/generics.md` — 废弃旧 "INumber 数值约束（iter 1）" 小节
- `docs/design/language/static-abstract-interface.md` — 标记 §7.2 完成
...
- [x] 1.4 `docs/design/language/generics.md` §"INumber 数值约束（iter 1）" 加
      DEPRECATED 注记，指向 "静态抽象接口成员" 节；保留文字作为历史
- [x] 1.5 `docs/design/language/generics.md` §"Operator 重载" 的 Desugar 优先级
      说明更新（去掉 "instance op_Add 兜底"）
- [x] 1.6 `docs/design/language/static-abstract-interface.md` §7.2 "移除
