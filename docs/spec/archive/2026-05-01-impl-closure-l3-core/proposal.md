...
| `docs/spec/changes/impl-closure-l3-core/{proposal,design,tasks}.md` + `specs/...` | NEW | 本变更规范 |

**只读引用**：
- `docs/spec/archive/2026-05-01-add-closures/specs/closure/spec.md` — R5/R6 行为契约
- `docs/spec/archive/2026-05-01-impl-lambda-l2/` — LoadFn / CallIndirect 已就位
- `docs/spec/archive/2026-05-01-impl-local-fn-l2/` — 同样 capture 路径
