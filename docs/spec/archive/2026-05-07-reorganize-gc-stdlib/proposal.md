...
- `docs/spec/archive/2026-04-29-expose-gc-to-scripts/tasks.md` —— 既有 GC.z42 builtin pattern
- `docs/spec/archive/2026-05-04-expose-weak-ref-builtin/` —— WeakHandle primitive 现状
