...
| `docs/design/language/delegates-events.md` | MODIFY | §6.3 IDisposable 段把"待 D-7-residual"标记改为"已落地"；§6.5 同款；status 行追加 D-7-residual |
...
- `docs/spec/archive/2026-05-04-add-event-keyword-singlecast/` — D-7 主体 spec 历史
