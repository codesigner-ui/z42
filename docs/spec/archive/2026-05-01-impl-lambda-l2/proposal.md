...
| `docs/spec/changes/impl-lambda-l2/proposal.md` | NEW | 本提案 |
| `docs/spec/changes/impl-lambda-l2/specs/lambda/spec.md` | NEW | 本变更 spec |
| `docs/spec/changes/impl-lambda-l2/design.md` | NEW | 实现设计 |
