...
- **文档更新**：[docs/design/testing/testing.md](docs/design/testing/testing.md) 加迁移完成状态与目录树
...
| `docs/design/testing/testing.md` | MODIFY | 标注 P3 完成；加目录树图 |
| `docs/design/testing/testing.md` | MODIFY | 迁移完成状态记录 |
| `docs/dev.md` | MODIFY | 测试命令段更新（按归属跑） |

**只读引用**：
- 全部 103 个现有 .z42 / .zbc / expected_output.txt（理解归属判定）
- [src/libraries/](src/libraries/) 各库的源码（理解依赖关系）
- [docs/design/testing/testing.md](docs/design/testing/testing.md) — P2 已建立的规范
