...
| **WS004 删除** | ManifestErrors.cs 移除 WS004 常量；docs/design/compiler/error-codes.md 同步删除 |
...
| `docs/design/compiler/project.md` | L7 章节追加脚手架 / clean / fmt 子节 |
| `docs/design/compiler/compiler-architecture.md` | 标注 C4c 完成 |
| `docs/design/compiler/error-codes.md` | 删除 WS004 残留引用 |
