...
**文档影响：** docs/design/runtime/ir.md（ToStr 语义 + String ops section）、docs/design/runtime/jit.md（jit_to_str 签名）
...
- [x] 1.7 docs/design/runtime/ir.md 新增 String Operations section（to_str 语义）+ v_call primitive dispatch
- [x] 1.8 docs/design/runtime/jit.md 更新 jit_to_str 签名
