...
Spec：[`docs/spec/changes/drop-index-json-self-describing/`](../../spec/changes/drop-index-json-self-describing/)（取代已归档的 `2026-05-12-fix-bundle-resolver-namespace-index/`）
