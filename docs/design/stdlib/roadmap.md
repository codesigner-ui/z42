...
| **z42.crypto** | `System.Security.Cryptography` | `ring` / `sha2` / `aes` | L2 | FFI | ✅ SHA-1 / SHA-256 / SHA-384 / SHA-512 / SHA3-224/256/384/512 + SHAKE128/256 + Keccak-256/512 (legacy) + HMAC for SHA-1/256/384/512 + CSPRNG `SecureRandom` + PBKDF2 + HKDF-SHA-256/512 + scrypt + AES-128/192/256 (ECB + CTR + CBC-PKCS7 + GCM) + ChaCha20 + Poly1305 已落地 (2026-05-24 → 2026-05-27)；hw-accel / non-96-bit-IV-GCM / ChaCha20-Poly1305-AEAD / X25519 / Ed25519 留 follow-up |
