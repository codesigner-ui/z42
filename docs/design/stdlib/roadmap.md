...
| **z42.crypto** | `System.Security.Cryptography` | `ring` / `sha2` / `aes` | L2 | FFI | ✅ SHA-1 / SHA-256 / SHA-384 / SHA-512 / SHA3-224/256/384/512 + HMAC for SHA-1/256/384/512 + CSPRNG `SecureRandom` + PBKDF2 + HKDF-SHA-256/512 + scrypt + AES-128/192/256 (ECB + CTR + CBC-PKCS7) 已落地 (2026-05-24 → 2026-05-27)；GCM / hw-accel / legacy-Keccak 留 follow-up |
...
| `sha3-future-keccak-legacy` | Legacy Keccak-256 with domain byte `0x01` (Ethereum / Solidity `keccak256` interop) | Ethereum 用例 |
