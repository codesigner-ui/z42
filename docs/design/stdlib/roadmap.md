...
| **z42.crypto** | `System.Security.Cryptography` | `ring` / `sha2` / `aes` | L2 | FFI | ✅ SHA-1 / SHA-256 / SHA-384 / SHA-512 / SHA3-224/256/384/512 + SHAKE128/256 + Keccak-256/512 (legacy) + BLAKE2b + BLAKE2s + HMAC for SHA-1/256/384/512 + CSPRNG `SecureRandom` + PBKDF2 + HKDF-SHA-1/256/512 + scrypt + AES-128/192/256 (ECB + CTR + CBC-PKCS7 + GCM + CCM) + ChaCha20 + Poly1305 + ChaCha20-Poly1305 AEAD + X25519 ECDH + Ed25519 signing + RSA (PKCS#1 v1.5 + PSS sign/verify + OAEP encrypt/decrypt + raw RSAEP/RSADP) + ECDSA P-256 + ECDSA secp256k1 (both RFC 6979 deterministic) 已落地 (2026-05-24 → 2026-05-28)；hw-accel / Argon2 / BLAKE3 留 follow-up |
