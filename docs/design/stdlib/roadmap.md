...
| `net-future-http-cookies-auto` | auto-jar on HttpClient (no manual IngestFromResponse) | session ergonomics |
| `net-future-http-cookies-persist` | save/load jar to file | long-running scripts / CLIs |
