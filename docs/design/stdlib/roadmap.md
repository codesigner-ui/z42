...
| **z42.crypto** | `System.Security.Cryptography` | `ring` / `sha2` / `aes` | L2 | FFI | ✅ SHA-1 / SHA-256 / SHA-384 / SHA-512 + HMAC for each + CSPRNG `SecureRandom` + PBKDF2 已落地 (2026-05-24 → 2026-05-27)；KDF (HKDF / scrypt) / 对称加密 (AES) 留 follow-up |
