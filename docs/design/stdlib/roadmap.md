...
| **z42.crypto** | `System.Security.Cryptography` | `ring` / `sha2` / `aes` | L2 | FFI | ✅ SHA-1 / SHA-256 / SHA-384 / SHA-512 / SHA3-224/256/384/512 + SHAKE128/256 + Keccak-256/512 (legacy) + BLAKE2b + HMAC for SHA-1/256/384/512 + CSPRNG `SecureRandom` + PBKDF2 + HKDF-SHA-256/512 + scrypt + AES-128/192/256 (ECB + CTR + CBC-PKCS7 + GCM) + ChaCha20 + Poly1305 + ChaCha20-Poly1305 AEAD 已落地 (2026-05-24 → 2026-05-28)；hw-accel / non-96-bit-IV-GCM / X25519 / Ed25519 / Argon2 / BLAKE2s / BLAKE3 留 follow-up |
