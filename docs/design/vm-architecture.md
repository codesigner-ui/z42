...
详见 [docs/design/embedding.md](embedding.md) 与 [docs/spec/archive/2026-05-10-add-embedding-api/design.md](../../spec/archive/2026-05-10-add-embedding-api/design.md) D1/D5。
...
`docs/design/language-overview.md` §6.3 + `docs/spec/archive/2026-05-02-fix-class-field-default-init/`。
