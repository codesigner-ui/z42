...
| S3 剩余 3 个 z42c codegen bug | dogfood S3 余 8 stdlib test：① cross-ns 静态调用误限定（Zip→Deflate）② blake3 多块 z42c codegen ③ diagnostics min-level/color。compression `[Native]` 已修 | [compiler/self-hosting.md](design/compiler/self-hosting.md#deferred--future-work) |
