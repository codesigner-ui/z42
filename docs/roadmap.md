...
| **C7+**（后续 spec，未排）| extern class T / manifest reader (.z42abi) / source generator import / CallNativeVtable runtime + IR codegen / Object/Str/TypeRef marshal / golden test 预注册 native lib harness | 📋 |
