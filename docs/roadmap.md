...
| Refactor BinaryReader/Writer to accept Stream | 第二步 — BinaryReader 从 byte[]-only 改成接受 Stream | [stdlib/io-stream.md](design/stdlib/io-stream.md#refactor-binary-reader-stream) |
