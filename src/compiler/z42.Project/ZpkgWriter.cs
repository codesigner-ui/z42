...
public static partial class ZpkgWriter
{
    ...
    public const ushort VersionMinor = 16;  // 2026-06-10 add-field-attribute-reflection: coupled with inner zbc 1.14 (per-field attr-ref block in TYPE section). Outer zpkg layout unchanged; bump tracks the inner zbc format change. Pre-0.16 not readable.
