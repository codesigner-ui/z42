...
pub(crate) fn primitive_method_builtin(obj: &Value, method: &str) -> Option<&'static str> {
    match (obj, method) {
        ...
        // L3-G2.5 INumber iteration 1: arithmetic method dispatch on primitives.
        (Value::I64(_),  "op_Add")      => Some("__int_op_add"),
        (Value::I64(_),  "op_Subtract") => Some("__int_op_subtract"),
        (Value::I64(_),  "op_Multiply") => Some("__int_op_multiply"),
        (Value::I64(_),  "op_Divide")   => Some("__int_op_divide"),
        (Value::I64(_),  "op_Modulo")   => Some("__int_op_modulo"),
        ...
        (Value::F64(_),  "op_Subtract") => Some("__double_op_subtract"),
        (Value::F64(_),  "op_Multiply") => Some("__double_op_multiply"),
        (Value::F64(_),  "op_Divide")   => Some("__double_op_divide"),
        (Value::F64(_),  "op_Modulo")   => Some("__double_op_modulo"),
