...
- 🟢 **H4 (android)** [`add-platform-android`](../../../docs/spec/archive/2026-05-12-add-platform-android/) ✅ —— `z42vm.aar` Gradle module；4 个 ABI cdylib（cargo-ndk）+ CMake JNI bridge；`AssetZpkgResolver` 默认实现
