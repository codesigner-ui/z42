...
所有平台 facade **统一架在 [Tier 2 `z42-host` crate](../embed/) 之上**；没有任何 facade 直接调 `z42_runtime::interp::*` 或 `z42_vm::host::*` extern C 函数 —— 那是 host 模块自己内部的事。
...
| 平台 | 目录 | spec | 状态 |
|------|------|------|------|
| iOS | [`ios/`](ios/) | [`add-platform-ios/`](../../../../docs/spec/changes/add-platform-ios/) | 📋 H4 |
| Android | [`android/`](android/) | [`add-platform-android/`](../../../../docs/spec/changes/add-platform-android/) | 📋 H4 |
| WASM | [`wasm/`](wasm/) | [`add-platform-wasm/`](../../../../docs/spec/changes/add-platform-wasm/) | 📋 H4 |
